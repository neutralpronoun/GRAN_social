...
PRINT_TIME = False
__all__ = [
    'clean_graphs', 'degree_mean', 'clustering_mean', 'orbit_mean_all', 'spectral_mean',
    'eval_acc_lobster_graph', 'radius_mean', 'omega_mean', 'sigma_mean', 'diffusion_mean'
]
...
def degree_mean(graph_pred_list, is_parallel=True):
...
def diffusion_mean(graph_pred_list,
...
def radius_mean(graph_pred_list, is_parallel=True, PRINT_TIME = True):
  ''' Compute the distance between the degree distributions of two unordered sets of graphs.
    Args:
      graph_ref_list, graph_target_list: two lists of networkx graphs to be evaluated
    '''
...
def omega_mean(graph_ref_list, graph_pred_list, is_parallel=True, PRINT_TIME = True):
  ''' Compute the distance between the degree distributions of two unordered sets of graphs.
    Args:
      graph_ref_list, graph_target_list: two lists of networkx graphs to be evaluated
    '''
...
def sigma_mean(graph_ref_list, graph_pred_list, is_parallel=True, PRINT_TIME = True):
  ''' Compute the distance between the degree distributions of two unordered sets of graphs.
    Args:
      graph_ref_list, graph_target_list: two lists of networkx graphs to be evaluated
    '''
...
def spectral_mean(graph_pred_list, is_parallel=True):
  ''' Compute the distance between the degree distributions of two unordered sets of graphs.
    Args:
      graph_ref_list, graph_target_list: two lists of networkx graphs to be evaluated
    '''
...
def clustering_mean(graph_pred_list,
                     bins=100,
                     is_parallel=True):
  sample_ref = []
  sample_pred = []
  ...
  if is_parallel:
    ...
    for i in range(len(graph_pred_list_remove_empty)):
      ...
      # hist, _ = np.histogram(
      #     clustering_coeffs_list, bins=bins, range=(0.0, 1.0), density=False)
      sample_pred.append(clustering_coeffs_list)
...
def orbit_mean_all(graph_ref_list, graph_pred_list):
  total_counts_ref = []
  total_counts_pred = []
